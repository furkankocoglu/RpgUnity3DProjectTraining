...
public class PlayerSkillCast : MonoBehaviour
{
    ...
    private int[] fadedImages = new int[] { 0, 0, 0, 0, 0, 0 };
    [HideInInspector]
    ...
    private PlayerOnClick playerOnClick=default;
    ...
    void CheckInput()
    {
        ...
        {            
            ...
            if (playerOnClick.FinishedMovement && fadedImages[0] != 1 && canAttack)
            {
        ...
        {
            playerOnClick.TargetPosition = transform.position;
            if (playerOnClick.FinishedMovement && fadedImages[1] != 1 && canAttack)
            {
        ...
        {
            playerOnClick.TargetPosition = transform.position;
            if (playerOnClick.FinishedMovement && fadedImages[2] != 1 && canAttack)
            {
        ...
        {
            playerOnClick.TargetPosition = transform.position;
            if (playerOnClick.FinishedMovement && fadedImages[3] != 1 && canAttack)
            {
        ...
        {
            playerOnClick.TargetPosition = transform.position;
            if (playerOnClick.FinishedMovement && fadedImages[4] != 1 && canAttack)
            {
        ...
        {
            playerOnClick.TargetPosition = transform.position;
            if (playerOnClick.FinishedMovement && fadedImages[5] != 1 && canAttack)
            {
