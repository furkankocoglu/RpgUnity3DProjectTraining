...
public class PlayerOnClick : MonoBehaviour
{
    ...
    private Vector3 newAttackPoint = default;

    private float currentSpeed = default;
    private float playerToPointDistance = default;
    private float gravity = 9.8f;
    private float height = default;

    private bool canMove = default;
    private bool canAttackMove = default;
    private bool finishedMovement = default;
    ...
    void MovePlayer()
    {
        if (Input.GetMouseButtonDown(1))
        {
            ...
            if (Physics.Raycast(ray,out hit))
            {
                ...
                {
                    enemy = hit.collider.GetComponentInParent<Transform>().gameObject;
                    canMove = true;
                    canAttackMove = true;
                }
            }
